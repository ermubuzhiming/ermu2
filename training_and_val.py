...
def train():
    ...
    train_data_dir = '\\home\\LY\\flowersdata\\tfrecord\\train\\traindata.tfrecords*'
    test_data_dir = '\\home\\LY\\tfrecord\\test\\testdata.tfrecords*'
...
def ckpt2cpy():
    # https://www.cnblogs.com/siucaan/p/9623111.html
